...
public enum ErrorType {
  ...
  INVALID_ANNOUNCEMENT_TITLE_LENGTH_ERROR(40010, "올바르지 않은 공지사항 제목 길이입니다."),
  INVALID_ANNOUNCEMENT_CONTENT_LENGTH_ERROR(40011, "올바르지 않은 공지사항 내용 길이입니다."),
  ...
  LOST_ITEM_NOT_FOUND_ERROR(40408, "해당 분실물을 찾을 수 없습니다."),
